      ...
      <div formArrayName="cities">
        ...
        <div class="container" formArrayName="experiences" *ngFor="let experience of experiences.controls; let n=index">
          ...
          <div formGroupName="{{n}}" class="form-group row">
            ...
            <input formControlName="companyName" id="companyName-{{n}}" class="form-control form-control-static col-sm-3 mb-2 mr-sm-2 mb-sm-0"/>
            
            <label class="sr-only" for="jobTitle">Job Title: </label>
            <input formControlName="jobTitle" id="jobTitle" class="form-control form-control-static col-sm-4 mb-2 mr-sm-2 mb-sm-0"/>
            
            <label class="sr-only" for="yearsWorked">Years Worked: </label>
            <input (blur)=onBlur($event) formControlName="yearsWorked" id="yearsWorked" class="form-control form-control-static col-sm-4 mb-2 mr-sm-2 mb-sm-0"/>
...
export class ExperiencesComponent implements OnInit {
  ...
  onBlur(event) {
    ...
    // this.firebaseService.setExperience()
  }
